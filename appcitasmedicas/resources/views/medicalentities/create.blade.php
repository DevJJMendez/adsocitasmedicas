        ...
        <form action="#" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <select class="custom-select" name="entity_type_id">
                    @forelse ($entitiesType as $entityType)
                    <option value="{{ $entityType->detail_id }}">{{ $entityType->name }}</option>
                    @empty
            ...
            <div class="input-group mb-3">
                ...
                <select class="custom-select" name="statu_type_id">
                    @forelse ($statuType as $statu)
                    <option value="{{$statu->detail_id}}">{{$statu->name}}</option>
                    @empty
                    <option value="#">No data found</option>
                    @endforelse
                </select>
