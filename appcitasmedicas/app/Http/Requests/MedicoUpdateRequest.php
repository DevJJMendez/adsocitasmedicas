    ...
    public function rules(): array
    {
        return [
            ...
            'identification_number' => [
                ...
                'string',
                'max:12',
                Rule::unique('third_data', 'identification_number')->ignore($this->route('medico')->third_data_id, 'third_data_id')
            ],
            ...
            'number_phone' => [
                ...
                'string',
                'max:30',
                Rule::unique('medico')->ignore('third_data_id')
            ],
            'birth_date' => [
                'required',
                'date',
